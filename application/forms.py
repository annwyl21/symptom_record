...
class Mcgill3Form(FlaskForm):
    #1
    mild = BooleanField('Mild', default=False)
    discomforting = BooleanField('Discomforting', default=False)
    distressing = BooleanField('Distressing', default=False)
    horrible = BooleanField('Horrible', default=False)
    excruciating = BooleanField('Excruciating', default=False)
